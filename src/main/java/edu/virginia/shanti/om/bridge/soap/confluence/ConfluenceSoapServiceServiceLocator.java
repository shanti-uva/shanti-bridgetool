...
public class ConfluenceSoapServiceServiceLocator extends org.apache.axis.client.Service implements edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceSoapServiceService {
    ...
    private java.lang.String ConfluenceserviceV1_address = "https://shanti-app-qa01.shanti.virginia.edu/rpc/soap-axis/confluenceservice-v1";
    ...
    public edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceSoapService getConfluenceserviceV1() throws javax.xml.rpc.ServiceException {
    ...
    public edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceSoapService getConfluenceserviceV1(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceserviceV1SoapBindingStub _stub = new edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceserviceV1SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceserviceV1SoapBindingStub _stub = new edu.virginia.shanti.om.bridge.soap.confluence.ConfluenceserviceV1SoapBindingStub(new java.net.URL(ConfluenceserviceV1_address), this);
                _stub.setPortName(getConfluenceserviceV1WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://shanti-app-qa01.shanti.virginia.edu/rpc/soap-axis/confluenceservice-v1", "ConfluenceSoapServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://shanti-app-qa01.shanti.virginia.edu/rpc/soap-axis/confluenceservice-v1", "confluenceservice-v1"));
        }
