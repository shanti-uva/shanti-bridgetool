...
public class SakaiLoginServiceLocator extends org.apache.axis.client.Service implements edu.virginia.shanti.om.bridge.soap.sakai.SakaiLoginService {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://collab-dev.its.virginia.edu/sakai-ws/soap/sakai", "SakaiLoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://collab-dev.its.virginia.edu/sakai-ws/soap/sakai", "SakaiLogin"));
        }
