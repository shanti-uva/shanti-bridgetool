...
public class RemoteContentPermissionSet  implements java.io.Serializable {
    private edu.virginia.shanti.om.bridge.soap.confluence.RemoteContentPermission[] contentPermissions;
    ...
    public RemoteContentPermissionSet(
           edu.virginia.shanti.om.bridge.soap.confluence.RemoteContentPermission[] contentPermissions,
     ...
     */
    public edu.virginia.shanti.om.bridge.soap.confluence.RemoteContentPermission[] getContentPermissions() {
        return contentPermissions;
    }
     ...
     */
    public void setContentPermissions(edu.virginia.shanti.om.bridge.soap.confluence.RemoteContentPermission[] contentPermissions) {
        this.contentPermissions = contentPermissions;
    }
