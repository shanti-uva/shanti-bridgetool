...
public class SudoSoapServiceTestCase extends junit.framework.TestCase {
    ...
    public void testsudoWSDL() throws Exception {
        ...
        java.net.URL url = new java.net.URL(new edu.virginia.shanti.om.bridge.soap.sakai.SudoSoapServiceLocator().getsudoAddress() + "?WSDL");
        javax.xml.rpc.Service service = serviceFactory.createService(url, new edu.virginia.shanti.om.bridge.soap.sakai.SudoSoapServiceLocator().getServiceName());
        assertTrue(service != null);
    }

    public void test1sudoCanUseConfluence() throws Exception {
        edu.virginia.shanti.om.bridge.soap.sakai.SudoSoapBindingStub binding;
        try {
            binding = (edu.virginia.shanti.om.bridge.soap.sakai.SudoSoapBindingStub)
                          new edu.virginia.shanti.om.bridge.soap.sakai.SudoSoapServiceLocator().getsudo();
        }
        ...
        catch (edu.virginia.shanti.om.bridge.soap.sakai.EntityException e1) {
